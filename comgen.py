...
for i in flist:
    filename=jname+'_'+i+'.com'
    fo=open(filename, 'w')
    # need to be careful for functionals that use empirical dispersion (b3lyp+d2 and b3lyp+d3)
    # these will need an extra keyword in the route section of the input file
